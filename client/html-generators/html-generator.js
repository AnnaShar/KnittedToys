const generateTable = (columns, items) => {
    ...
    table.classList.add('table', 'toys-table');
...
const generateRow = (columnIDs, values, type) => {
    ...
    row.classList.add('table__row', `row-${type}`);
...
const generateCell = (column, value, type) => {
    ...
    cell.classList.add('table__cell', `cell-${type}`);
...
const generateButtonCell = () => {
    ...
    btnCell.classList.add('table__button-wrap');
    return btnCell;
};
